...
const addSwitcher = () => {
    if (backgroundSwitch === 'true') {
        ...
        landingpagecover.style.backgroundImage = "url('http://127.0.0.1:8000/assets/css/2.png')";
        interval = setInterval(() => {
            let randomNumber = Math.floor(Math.random() * imgsArray.length);
            landingpagecover.style.backgroundImage = 'url("http://127.0.0.1:8000/assets/css/' + imgsArray[randomNumber] + '")';
        }, 10000)
    }
